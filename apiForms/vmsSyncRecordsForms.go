...
*/
type ListByPVmsSyncRecordsDataValidate struct {
...
*/
type ListByPVmsSyncRecordsDetailDataValidate struct {
	UserToken  *string `json:"userToken" binding:"required"`
...
/**
 * @apiDefine RequestSyncWithVMSDataValidate
 * @apiParam {String} userToken userToken <a style="color:red">[required]</a>. <br/>
...
*/
type RequestSyncWithVMSDataValidate struct {
	UserToken  *string `json:"userToken" binding:"required"`
}
